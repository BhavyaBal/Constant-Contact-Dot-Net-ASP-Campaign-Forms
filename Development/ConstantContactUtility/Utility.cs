...
namespace ConstantContactUtility
{
    ...
    public class Utility
    {
        ...
        #region Email - Retrieve entire collection
        /// <summary>
        ...
        public static IList<Email> GetEmailCollection(AuthenticationData authenticationData)
        {
            ValidateAuthenticationData(authenticationData);

            string currentAddress = String.Format(CultureInfo.InvariantCulture, "{0}", authenticationData.AccountEmailsListUri);
            ...
            try
            {
                ...
                return EmailComponent.GetEmailCollection(stream);
            }
            catch (Exception e)
            {
                throw new ConstantException(e.Message, e);
